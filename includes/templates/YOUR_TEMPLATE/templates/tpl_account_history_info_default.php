 ...
 * @copyright Copyright 2012-2015 Vinos de Frutas Tropicales (lat9): Minimum Customer Account Information
...
<?php if ($messageStack->size('account_history_info') > 0) echo $messageStack->output('account_history_info'); ?>
