      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main" valign="top"><strong><?php /*-bof-minacct-avpns  *** 1 of 5 *** echo ENTRY_SHIPPING_ADDRESS;*/ echo '&nbsp'; /*-eof-minacct-avpns  *** 1 of 5 ***/ ?></strong></td>
                <td class="main"><?php /*-bof-minacct-avpns  *** 2 of 5 *** echo zen_address_format($order->delivery['format_id'], $order->delivery, 1, '', '<br />');*/ echo '&nbsp'; /*-eof-minacct-avpns  *** 2 of 5 ***/ ?></td>
              </tr>
            </table></td>
            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
              <tr>
...
?>
      ...
      <tr>
        <td colspan="2" align="right" class="noprint"><?php echo '<a href="' . zen_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $_GET['oID']) . '" TARGET="_blank">' . zen_image_button('button_invoice.gif', IMAGE_ORDERS_INVOICE) . /*-bof-minacct-avpns  *** 4 of 5 *** '</a> <a href="' . zen_href_link(FILENAME_ORDERS_PACKINGSLIP, 'oID=' . $_GET['oID']) . '" TARGET="_blank">' . zen_image_button('button_packingslip.gif', IMAGE_ORDERS_PACKINGSLIP) . -eof-minacct-avpns  *** 4 of 5 ***/'</a> <a href="' . zen_href_link(FILENAME_ORDERS, zen_get_all_get_params(array('action'))) . '">' . zen_image_button('button_orders.gif', IMAGE_ORDERS) . '</a>'; ?></td>
      </tr>
<?php
...
//      $contents[] = array('text' => TEXT_INFO_DELETE_INTRO . '<br /><br /><strong>' . $cInfo->customers_firstname . ' ' . $cInfo->customers_lastname . '</strong>');
    ...
    default:
      if (isset($oInfo) && is_object($oInfo)) {
        ...
        $contents[] = array('align' => 'center', 'text' => '<a href="' . zen_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $oInfo->orders_id) . '" TARGET="_blank">' . zen_image_button('button_invoice.gif', IMAGE_ORDERS_INVOICE) . /*-bof-minacct-avpns  *** 5 of 5 *** '</a> <a href="' . zen_href_link(FILENAME_ORDERS_PACKINGSLIP, 'oID=' . $oInfo->orders_id) . '" TARGET="_blank">' . zen_image_button('button_packingslip.gif', IMAGE_ORDERS_PACKINGSLIP) . -eof-minacct-avpns  *** 5 of 5 ***/ '</a>');
